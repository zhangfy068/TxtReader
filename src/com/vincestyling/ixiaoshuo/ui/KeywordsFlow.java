...
/**
 * vincestyling : This widget wasn't achieved by myself, I can't figure out the original author.
 */
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener {
    ...
    //颜色随机值选取范围
    private int[] COLOR_ARRAY = new int[]{0x00ED9004, 0x0084C9C9, 0x00008B89, 0x00E1000A, 0x00D58C39,
            0x0033AAD6, 0x00E47521, 0x00A3D3AC, 0x00FE8AD1, 0x0076C75B
    };
        ...
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0 && enableShow) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (i < COLOR_ARRAY.length - 1) {
                    ranColor = 0xff000000 | COLOR_ARRAY[i];
                } else {
                    ranColor = 0xff000000 | COLOR_ARRAY[i % COLOR_ARRAY.length];
                }
